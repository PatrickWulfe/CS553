...
public class Main {
    ...
    public static void main (String [] loginIDarray) {
        ...
        /** Changed code to use a singleton for creating factories. */
        ...
        if (1000 < loginId && loginId <= 5000)
	        ...
	        factory = new AbstractFactoryStd ();
	    else if (8000 < loginId && loginId <= 9999)
	        factory = new AbstractFactoryPro ();
        else {
            System.err.println ("Argument out of range");
            System.exit (1);
        }*/
        AbstractFactoryCreator afc = AbstractFactoryCreator.getAfc();
        AbstractFactoryIF factory = afc.createAbstractFactory(loginId);
